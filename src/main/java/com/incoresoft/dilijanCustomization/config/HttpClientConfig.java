...
@Configuration
@EnableConfigurationProperties({VezhaApiProps.class, VezhaDbProps.class, CafeteriaProps.class, EvacuationProps.class, PostgresProps.class, UnknownProps.class})
